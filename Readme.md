...
Стрессоустойчивый: работал в режиме многозадачности, работал на 2 ставки и успешно справлялся с задачами.  
...
![Git - система контроля версий](image.png)  
![Основы языка программирования Python](image-1.png)
